...
export abstract class AbstractCurrencyComponent implements OnInit {
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.Currencies.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.Currencies.Delete');
