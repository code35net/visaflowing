...
export abstract class AbstractProductComponent implements OnInit {
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.Products.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.Products.Delete');
