...
export abstract class AbstractProductGroupComponent implements OnInit {
  ...
  checkChildEntityPermissions() {
    ...
    const childPermissions = ['VisaFlowing.Products'];
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.ProductGroups.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.ProductGroups.Delete');
