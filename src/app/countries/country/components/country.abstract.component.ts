...
export abstract class AbstractCountryComponent implements OnInit {
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.Countries.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.Countries.Delete');
