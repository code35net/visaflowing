...
export abstract class AbstractBasketItemComponent implements OnInit {
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.BasketItems.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.BasketItems.Delete');
