...
export abstract class AbstractSourceComponent implements OnInit {
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.Sources.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.Sources.Delete');
