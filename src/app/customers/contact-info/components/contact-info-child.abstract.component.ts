...
export abstract class AbstractContactInfoComponent implements OnInit {
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.ContactInfos.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.ContactInfos.Delete');
