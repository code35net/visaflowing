...
export abstract class AbstractPassportComponent implements OnInit {
  ...
  checkActionButtonVisibility() {
    ...
    const canEdit = this.permissionService.getGrantedPolicy('VisaFlowing.Passports.Edit');
    const canDelete = this.permissionService.getGrantedPolicy('VisaFlowing.Passports.Delete');
